...
# --- CUSTOM SCHEMA DEFINITIONS (kwargs NOT in required) ---
run_report_custom_input_schema = {
    ...
    "properties": {
        ...
        "kwargs":      {"title": "Kwargs",      "description": "Additional keyword arguments for the report.", "type": "object", "properties": {}, "additionalProperties": True }
    },
    "required": ["metrics"] # <<< "kwargs" REMOVED FROM REQUIRED
}
...
run_realtime_report_custom_input_schema = {
    ...
    "properties": {
        ...
        "kwargs":      {"title": "Kwargs",      "description": "Additional keyword arguments for the realtime report.", "type": "object", "properties": {}, "additionalProperties": True }
    },
    "required": ["metrics"] # <<< "kwargs" REMOVED FROM REQUIRED
}
...
get_metadata_custom_input_schema = {
    ...
    "properties": {
        ...
        "property_id": {"title": "Property Id", "description": "GA4 Property ID (e.g., '123456789').", "default": None, "anyOf": [{"type": "string"}, {"type": "null"}]},
        "kwargs":      {"title": "Kwargs",      "description": "Additional keyword arguments.", "type": "object", "properties": {}, "additionalProperties": True }
    },
    "required": [] # <<< "kwargs" REMOVED FROM REQUIRED (was the only one)
}
